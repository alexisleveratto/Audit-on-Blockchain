...
def add_client(cuit, client_name, email, address, localidad, zip_code, provincia, country):
    client = Cliente(
        client_cuit=cuit,
...
def test_new_client_ok():
    ...
    assert add_client(test_cuit, test_client_name, test_email, test_address, test_localidad, test_zip_code, test_provincia, test_country)
...
def test_new_client_fail():
    ...
    test_provincia = "test_provincia"
    test_country = "test_country"
    assert not(add_client(test_cuit, test_client_name, test_email, test_address, test_localidad, test_zip_code, test_provincia, test_country))
    assert delete_client(test_cuit)
...
def test_modify_client_ok():
    ...
    old_client = BlockchainManager.getSingle(ns_name="/Compania", id=str("/" + test_cuit))
    ...
    updated_client = BlockchainManager.getSingle(ns_name="/Compania", id=str("/" + test_cuit))
